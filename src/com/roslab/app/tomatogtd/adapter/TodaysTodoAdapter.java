...
public class TodaysTodoAdapter extends FragmentStatePagerAdapter {
	...
	public TodaysTodoAdapter(FragmentManager fragmentManager,
			ArrayList<TodaysTodoItem> todaysTodoList) {
	...
	public Fragment getItem(int index) {
		return TodaysTodoItemFragment.newInstance(
				todaysTodoList.get(index % count));
	}
